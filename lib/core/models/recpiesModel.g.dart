...
part of 'recpiesModel.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class RecpiesAdapter extends TypeAdapter<Recpies> {
  @override
  final int typeId = 0;

  @override
  Recpies read(BinaryReader reader) {
    ...
    return Recpies(
      ...
      strDrinkAlternate: fields[2] as Null?,
      ...
      strImageSource: fields[50] as Null?,
      strCreativeCommonsConfirmed: fields[51] as Null?,
      dateModified: fields[52] as Null?,
    );
  }

  @override
  void write(BinaryWriter writer, Recpies obj) {
    writer
      ..writeByte(53)
      ..writeByte(0)
      ..write(obj.idMeal)
